'''
1. To start FastAPI, we can use any of the below commands -
...
'''
We can remove async in the below function definition, as it is added by default in the FastAPI
'''
@app.get("/books")
